...
| Category            | Details                                                                                                                                                               |
| :------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🤖 **Interests**     | 🤖 AI, 🧠 Machine Learning, ⚙️ Deep Learning, 🌐 Web Development, ✨ UI/UX Design, 🎯 Problem Solving, 🤝 Collaboration, ♾️ Continuous Learning                          |
| 🌱 **Currently Learning** | Advanced AI/ML techniques at NVIDIA AI Academy, Cutting-edge game development techniques, Exploring the Metaverse 🌠                                                  |
| 🤝 **Collaboration** | Open Source Projects, AI/ML Research & Development, Full-Stack Web Applications, Data Science Initiatives, Game Development Ventures                                 |
